...
unsigned char xor_rowHeight = 8;
unsigned char xor_textYOffset = 0;
...
//    xor_Char(xor_cursorX * 8 + xor_clipX + 8, xor_cursorY * xor_rowHeight + xor_clipY - 2, toPrint);
    xor_Char(xor_cursorX * 8 + xor_clipX + 8, xor_cursorY * xor_rowHeight + xor_clipY - 2 + xor_textYOffset, toPrint);
    xor_cursorX++;
