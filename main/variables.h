...
#define UPGRADE_FIRST_ROW_Y 34
#define UPGRADE_ROW_STEP    9

//#define UPGRADE_SEL_Y(i) (UPGRADE_FIRST_ROW_Y + (i) * UPGRADE_ROW_STEP)
#define MARKET_SEL_Y(i) ((((i) + 3) * 9) - 8)
//#define UPGRADE_SEL_Y(i) (HEADER_DIVIDER_Y + 11 + 9 * (i))
#define UPGRADE_SEL_Y(i) (33 + (i) * 9)
...
//#define VIEW_VCENTER      ((screen_h - DASH_HEIGHT + 5) / 2)
#define VIEW_VCENTER      ((xor_clipHeight) / 2)
...
#define MM_SELBAR_X      (xor_clipX + LEFT_TEXT_INDENT - 2)
#define MM_SELBAR_WIDTH  (screen_w - MM_SELBAR_X - 2)
...
#define SOI_INDIC_POS_X   (DASH_HOFFSET_CENTER + (dashcenter_width / 2) - 14)
...
#define COMPASS_HCENTER   (DASH_HOFFSET_CENTER + 67)
...
#define INVENTORY_SEL_Y(i) MARKET_SEL_Y(i)
