...
static unsigned char mkt_qtyRow = 0;
...
//        if (enter == 1) { mkt_Buy(menu_selOption); drawMenu(false); }
        if (enter == 1) 
        {
            mkt_qtyRow = menu_selOption;

            mkt_qtyGood = menu_selOption; 
            mkt_qtyValue = 0; 
            mkt_qtyBuy = true; 
...
//else
//{
//    unsigned char countAfterSell = mkt_GetInventoryCount();

//    if (countAfterSell == 0)
//        menu_selOption = 0;
//    else if (menu_selOption >= countAfterSell)
//        menu_selOption = countAfterSell - 1;
//}

if (mkt_qtyBuy)
{
    menu_selOption = mkt_qtyRow;
}
else
{
...
//        if (count == 0)
//            menu_selOption = 0;
//        else if (menu_selOption >= count)
//            menu_selOption = count - 1;
//    }

//    bool resetCursor = true;

//    if ((lastMenu == MARKET_QTY && currentMenu == MARKET) ||
//        (lastMenu == MARKET_QTY && currentMenu == INVENTORY))
//    {
//        resetCursor = false;
//    }

//    drawMenu(resetCursor);
//}
