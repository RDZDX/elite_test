...
//static const unsigned char titleScale[] =
//{
//    100, // Sidewinder
//    90,  // Viper
//    100, // Mamba
...
//unsigned int scale = titleScale[ship->shipType];

//const struct vector_t vertexVector = {
//    (((vertexData[3] & 0x80) ? -vertexData[0] : vertexData[0]) * scale) / 100,
//    (((vertexData[3] & 0x40) ? -vertexData[1] : vertexData[1]) * scale) / 100,
//    (((vertexData[3] & 0x20) ? -vertexData[2] : vertexData[2]) * scale) / 100
//};
